...
Future<void> showCallkitIncoming(String uuid) async {
  final params = CallKitParams(
    ...
    android: const AndroidParams(
      ...
      actionColor: '#4CAF50',
      textColor: '#ffffff',
      incomingCallCustomWidgetRoute: AppRoute.incomingCallHeader,
...
void main() {
  ...
  // When launched as a secondary Flutter engine for the incoming call header,
  // skip Firebase init and render only the custom widget.
  final route = WidgetsBinding.instance.platformDispatcher.defaultRouteName;
  if (route.startsWith(AppRoute.incomingCallHeader)) {
...
class MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    final initialRoute =
        (platformInitialRoute.isNotEmpty && platformInitialRoute != '/')
